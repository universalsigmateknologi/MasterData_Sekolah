...
class SiswaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'agama': forms.TextInput(attrs={'class': 'w-full text-sm bg-neutral-50 border border-border-light rounded-xl px-3 py-2.5 text-neutral-800 focus:outline-none focus:ring-2 focus:ring-neutral-300'}),
            'golongan_darah': forms.TextInput(attrs={'class': 'w-full text-sm bg-neutral-50 border border-border-light rounded-xl px-3 py-2.5 text-neutral-800 focus:outline-none focus:ring-2 focus:ring-neutral-300'}),
